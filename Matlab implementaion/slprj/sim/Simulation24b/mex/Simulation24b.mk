...
MODEL                   = Simulation24b
MODULES                 = Simulation24b_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\Simulation24b_msf.mexw64
MAKEFILE                = Simulation24b.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2025b
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2025b
START_DIR               = C:\Users\nabil\OneDrive\DOCUME~1\MATLAB\SMARTB~1\HARDWA~1\G3efar
S_FUNCTIONS_LIB         = $(START_DIR)\slprj\sim\_sharedutils\rtwshared.lib
NUMST                   = 2
NCSTATES                = 0
BUILDARGS               =  GENERATE_ASAP2=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 OPTS="-DIS_SIM_TARGET -DENABLE_SLEXEC_SSBRIDGE=1 -DMATLAB_MEX_FILE -DTID01EQ=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:Simulation24b_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = Simulation24b_msf.mexw64
MODELREF_LINK_LIBS        = "C:\Users\nabil\OneDrive\Documents\MATLAB\smart batch\hardwareTesting\G3efar\slprj\sim\Simulation24b\Simulation24blib.lib"
MODELREF_LINK_RSPFILE     = Simulation24b_ref.rsp
COMPILER_COMMAND_FILE     = Simulation24b_comp.rsp
...
Simulation24b_msf.obj : $(START_DIR)\slprj\sim\Simulation24b\Simulation24b_msf.c
	@cmd /C echo ### Compiling "$(START_DIR)\slprj\sim\Simulation24b\Simulation24b_msf.c"
	$(CC) $(CFLAGS) $(START_DIR)\slprj\sim\Simulation24b\Simulation24b_msf.c
